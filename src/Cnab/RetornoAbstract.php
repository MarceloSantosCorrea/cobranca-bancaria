...
abstract class RetornoAbstract
{
    ...
    */
    ...
    public function __construct($conteudo)
    {
        ...
        $class            = 'CobrancaBancaria\Cnab\resources\\' . self::$banco . '\retorno\\' . self::$layout . '\Registro0';
        $this->children[] = new $class($lines[0]);

        $class            = 'CobrancaBancaria\Cnab\resources\\' . self::$banco . '\retorno\\' . self::$layout . '\Registro9';
