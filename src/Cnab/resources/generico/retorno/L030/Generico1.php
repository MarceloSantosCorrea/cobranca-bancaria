...
use CobrancaBancaria\Cnab\RetornoAbstract;
...
class Generico1 extends RegistroRetAbstract
{
    ...
    {
        $class            = 'CobrancaBancaria\Cnab\resources\\' . RetornoAbstract::$banco . '\remessa\\' . RetornoAbstract::$layout . '\Registro3P';
    ...
    public function getText()
    {
        ...
        if ($this->children) {
            ...
            $class     = 'CobrancaBancaria\Cnab\resources\\' . RetornoAbstract::$banco . '\remessa\\' . RetornoAbstract::$layout . '\Registro5';
