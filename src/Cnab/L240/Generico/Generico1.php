...
class Generico1 extends AbstractRemessaRegistro
{
    protected $counter = 0;
    ...
    {
        $class            = 'CobrancaBancaria\Cnab\resources\\' . AbstractRemessa::$banco . '\remessa\\' . AbstractRemessa::$layout . '\Registro3P';
    ...
    public function getText()
    {
        ...
        if ($this->children) {
            ...
            $class     = 'CobrancaBancaria\Cnab\resources\\' . AbstractRemessa::$banco . '\remessa\\' . AbstractRemessa::$layout . '\Registro5';
