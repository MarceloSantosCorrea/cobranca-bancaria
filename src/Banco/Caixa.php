...
namespace CobrancaBancaria\Banco;

use CobrancaBancaria\Boleto;
use CobrancaBancaria\Banco;
use CobrancaBancaria\Util\Modulo;
...
class Caixa extends Banco
{
    protected function init()
    {
        ...
        $this->setCodigo("104");
        $this->setNome("CAIXA ECONOMICA FEDERAL");
        $this->setAceite("N");
